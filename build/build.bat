...
copy /b latkpy\latk\latk.py+latk_main.py+latk_tools.py+latk_rw.py+latk_mtl.py+latk_mesh.py+latk_draw.py+latk_shortcuts.py+latk_ui.py+latk_svg.py %BUILD_TARGET%
...
copy %BUILD_TARGET% "%homepath%\AppData\Roaming\Blender Foundation\Blender\3.4\scripts\addons"
