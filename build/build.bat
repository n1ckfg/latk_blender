...
copy /b latk_main.py+latk_tools.py+latk_rw.py+latk_mtl.py+latk_mesh.py+latk_draw.py+latk_freestyle.py+latk_shortcuts.py+latk_tilt.py+latk_ui.py %BUILD_TARGET%
